...
const { patient, getPatient, updatePatient,  errors } = usePatients();
...
<template>
        ...
        <div class="flex flex-col items-center justify-between xl:flex-row">
          <div class="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
            ...
            <p class="max-w-xl mb-4 text-base text-gray-400 md:text-lg">
              Please fill out the form to update patient's data.
              The patient will be updated to the list of patients.
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"></path>
              ...
              <h3
                class="mb-2 text-xl font-semibold sm:text-center sm:text-2xl"
              >
                Edit Patient
              </h3>
              <form class="mt-8 space-y-6" @submit.prevent="updatePatient($route.params.id)">
